                ...
                <div class="mr-6">
                    @auth
                        <a href="{{ route('video.create') }}"
                            class="inline-flex items-center px-6 py-1 bg-gray-700 border border-transparent rounded-xl font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-600 active:bg-gray-800 focus:outline-none focus:border-gray-900 focus:ring ring-gray-300 disabled:opacity-25 transition ease-in-out duration-150">
                            <?xml version="1.0" encoding="UTF-8" standalone="no"?>
                            <svg class="w-6 mr-2" width="32px" height="32px" viewBox="0 0 32 32" version="1.1" <g
                                id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"
                                sketch:type="MSPage">
                                <g id="Icon-Set-Filled" sketch:type="MSLayerGroup"
                                    transform="translate(-466.000000, -1089.000000)" class="fill-gray-200">
                                    <path
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        ...
                        <button
                            ...
                            @else
                                <div class="capitalize">Connexion</div>
                            @endauth
                            <div class="ml-1">
                    ...
                    <x-slot name="content">
                        @auth
                            <x-dropdown-link :href="route('channel', Auth::user()->id)">Ma Chaîne</x-dropdown-link>
                            @if (Auth::user()->role == 'admin')
                                <hr>
                                <h1
                                    class="block px-4 py-2 text-xs font-bold uppercase leading-5 text-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition duration-150 ease-in-out">
                                    Administration</h1>
                                <x-dropdown-link :href="route('users')">Gestion des utilisateurs</x-dropdown-link>
                            @endif
                            <hr>
                            <!-- Authentication -->
                        ...
                        @else
                            <x-dropdown-link :href="route('login')">Se connecter</x-dropdown-link>
